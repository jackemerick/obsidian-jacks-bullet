var T=Object.defineProperty;var L=Object.getOwnPropertyDescriptor;var N=Object.getOwnPropertyNames;var A=Object.prototype.hasOwnProperty;var M=(a,e)=>{for(var t in e)T(a,t,{get:e[t],enumerable:!0})},O=(a,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let o of N(e))!A.call(a,o)&&o!==t&&T(a,o,{get:()=>e[o],enumerable:!(s=L(e,o))||s.enumerable});return a};var B=a=>O(T({},"__esModule",{value:!0}),a);var Q={};M(Q,{default:()=>y});module.exports=B(Q);var i=require("obsidian");function R(a){let e=a||"Meu";return{logsFolder:`Di\xE1rio de ${e}`,projectsFolder:`Projetos de ${e}`,collectionsFolder:`Cole\xE7\xF5es de ${e}`,recurringFile:"recorrentes.md"}}var J={userName:"",onboardingDone:!1,logsFolder:"logs",projectsFolder:"projetos",collectionsFolder:"cole\xE7\xF5es",recurringFile:"recorrentes.md"};function d(){return new Date}function F(a){return String(a).padStart(2,"0")}function g(a){return`${a.getFullYear()}-${F(a.getMonth()+1)}-${F(a.getDate())}`}function u(a){return`${a.getFullYear()}-${F(a.getMonth()+1)}`}function b(a){return String(a.getFullYear())}function f(a,e){let t=new Date(a);return t.setDate(t.getDate()+e),t}function j(a,e){let t=new Date(a);return t.setMonth(t.getMonth()+e),t}var q=["Janeiro","Fevereiro","Mar\xE7o","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"],I=["Dom","Seg","Ter","Qua","Qui","Sex","S\xE1b"];function C(a){return q[a.getMonth()]}function V(a,e,t){let s=new Date(a,e,t),o=F(t),n=F(e+1),r=String(a).slice(2),c=I[s.getDay()];return`${o}/${n}/${r} - ${c}`}function H(a){return new Date(a.getFullYear(),a.getMonth()+1,0).getDate()}function X(){return`# Tarefas Recorrentes
...
-
-
`}function D(a,e){let t=Object.entries(a);return t.length===0?`> Nenhuma tarefa ativa em projetos.
`:t.map(([s,o])=>{let n=s.toLowerCase().replace(/\s+/g,"-").replace(/[^\w-]/g,"");return`### [[${e}/${n}|${s}]]
${o.map(r=>`- [ ] ${r}`).join(`
`)}`}).join(`

`)}function z(a,e,t,s,o){let n=g(a),r=u(a),c=b(a),l=g(f(a,-1)),p=g(f(a,1)),h=u(f(a,-1)),m=u(f(a,1)),S=e.length>0?e.map($=>`- [ ] ${$}`).join(`
`):"- [ ] ",k=t.length>0?t.map($=>`- [ ] ${$}`).join(`
`):"- [ ] ",P=D(s,o);return`# Di\xE1rio \u2014 ${n}

\u2190 [[${h}/${l}|\u2190 Ontem]] | [[${m}/${p}|Amanh\xE3 \u2192]]
[[../../mensal/${r}|\u2191 ${C(a)} ${c}]]
...
*\u2190 [[../../../INDEX|Dashboard]] | [[../../mensal/${r}|Log Mensal]]*
`}function W(a,e){let t=u(a),s=b(a),o=C(a),n=u(j(a,-1)),r=u(j(a,1)),c=H(a),l=Array.from({length:c},(p,h)=>`| ${V(a.getFullYear(),a.getMonth(),h+1)} | |`).join(`
...
`}function Y(a){return`# Log Futuro \u2014 ${a}
...
*\u2190 [[../../INDEX|Dashboard]]*
`}function U(a){let e=g(d());return`# Cole\xE7\xE3o \u2014 ${a}
...
*\u2190 [[../INDEX|Dashboard]]*
`}function _(a){let e=g(d());return`# Projeto \u2014 ${a}
...
`),s=[],o=!1;for(let n of t){if(/^## Tarefas Ativas/.test(n)){o=!0;continue}if(o&&/^## /.test(n))break;o&&/^- \[ \] .+/.test(n)&&s.push(n.replace(/^- \[ \] /,"").trim())}return s}async syncProjectsToTodayLog(){let e=g(d()),t=u(d()),s=`${this.dailyFolder}/${t}/${e}.md`,o=this.app.vault.getAbstractFileByPath(s);if(!(o instanceof i.TFile))return;let n=await this.app.vault.read(o),r=await this.getActiveProjectTasks(),c=D(r,this.settings.projectsFolder),l=n.replace(/(## Projetos\n)([\s\S]*?)(\n---)/,`$1
${c}
